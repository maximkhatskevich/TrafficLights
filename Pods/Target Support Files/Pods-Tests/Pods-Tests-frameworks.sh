...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/MKHState/MKHState.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MKHViewEvents/MKHViewEvents.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/XCEUniFlow/XCEUniFlow.framework"
